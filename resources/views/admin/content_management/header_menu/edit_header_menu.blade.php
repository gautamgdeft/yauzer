...
<aside class="right-side">
 ...
 <section class="content-header">
  ...
  <ol class="breadcrumb">
   ...
   <li class="active">Edit Header Menu</li>
 </ol>
</section>
...
<section class="content">
  <div class="box box-primary">
   <!-- form start -->
   <form id="edit-header-form" role="form" action="{{ route('admin.update_header_menu',['slug' => $headerMenu->slug]) }}" enctype="multipart/form-data" method="POST">
    {{ csrf_field() }}
    <div class="box-body">
     ...
     <div class="form-group{{ $errors->has('page_id') ? ' has-error' : '' }}">
        ...
        <select class="form-control" id="menu_name" name="page_id" required="required">
          ...
          @if(@sizeof($pages))
           ...
           <option value="{{ $loopingPage->id }}" @if($headerMenu->page_id == $loopingPage->id) selected="selected" @endif>{{ $loopingPage->name }}</option>
           @endforeach
          @endif
        </select>
     ...
     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
      ...
      <input type="text" class="form-control" id="name" name="name" value="{{ $headerMenu->name }}" required="required">
    ...
    <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
      ...
      <input type="text" class="form-control" id="url" name="url" value="{{ $headerMenu->url }}" required="required">
  ...
  <div class="box-footer">
   <button id="header-submit-btn" type="submit" class="btn btn-primary">Update</button>
