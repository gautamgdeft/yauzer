...
<aside class="right-side">
 ...
 <section class="content-header">
  ...
  <ol class="breadcrumb">
   ...
   <li class="active">Footer Menu Management</li>
 </ol>
</section>
...
<section class="content">
 <div class="row">
  <div class="col-xs-12">
   <div class="box">
    <div class="box-header">
     <a href="{{ route('admin.show_footer_menu_form') }}" class="btn bg-olive btn-flat">Add New Footer Menu</a>

         
    <div class="box-tools">
        <form action="{{ route('footermenu.search') }}" method="POST" role="search">
          {{ csrf_field() }}
    ...
    @if(isset($details))
     <a href="{{ route('admin.footermenus') }}" class="btn btn-danger btn-flat search-filter">Clear Filter</a>
    @endif  
  ...
  {{-- All Footer Menu Result Display --}}
  ...
  <div class="box-body table-responsive no-padding">
    <table class="table table-hover table-bordered">
      ...
      @if(!is_null($footerMenus))
      @foreach($footerMenus as $loopingMenus)
      <tr class="tr_{{ $loopingMenus->id }}">
        ...
        <td>
          ...
          <a href="{{ route('admin.edit_footer_menu', ['slug' => $loopingMenus->slug]) }}" class="btn btn-warning btn-flat" data-toggle="tooltip" title="Edit Menu"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
          <a href="{{ route('admin.view_footer_menu',['slug' => $loopingMenus->slug]) }}" class="btn btn-info btn-flat" data-toggle="tooltip" title="View Footer Menu"><i class="fa fa-eye" aria-hidden="true"></i></a>                    
        </td>
...
<div class="box-footer clearfix">
    <ul class="pagination pagination-sm no-margin pull-right">
        <li>@if($footerMenus){!! $footerMenus->render() !!}@endif</li>
    </ul>
</div>
@endif  


{{-- Searching Result Footer Menu Display --}}
  @if(isset($details))
  <div class="box-body table-responsive no-padding">
...
$('.active_menu').click(function()
{
  ...
  $.ajax({
   headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},    	
   url: "{{ route('admin.update_footer_menu_status') }}",
   type: "post",
   dataType: "JSON",
   data: { 'id': $(this).data('id') },
   success: function(response)
