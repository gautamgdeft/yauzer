         ...
         <form role="form" action="{{ route('admin.store_slider_image') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="box-body">
               ...
               <div class="form-group{{ $errors->has('h2_description') ? ' has-error' : '' }}">
                  ...
                  <input type="text" class="form-control" id="h2_description" name="h2_description" value="{{ old('h2_description') }}" required="required">
               ...
               <div class="form-group{{ $errors->has('h3_description') ? ' has-error' : '' }}">
                  ...
                  <input type="text" class="form-control" id="h3_description" name="h3_description" value="{{ old('h3_description') }}" required="required">
