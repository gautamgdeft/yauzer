...
<section class="content">
  <div class="box box-primary">
   <!-- form start -->
   <form id="edit-owner-form" role="form" action="{{ route('admin.update_owner',['slug' => $user->slug]) }}" enctype="multipart/form-data" method="POST">
    {{ csrf_field() }}
    <div class="box-body">
  ...
  <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
    ...
    <input type="text" class="form-control input-medium bfh-phone" value="{{ $user->phone_number }}" data-country="US" data-number="{{ $user->phone_number }}" id="phone_number" name="phone_number" required="required">
...
<div class="box-footer">
 <button id="submit-edit-owner-btn" type="submit" class="btn btn-primary">Update</button>
