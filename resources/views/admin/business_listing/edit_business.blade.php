...
<aside class="right-side">
   ...
   <section class="content-header">
      <h1> Edit Biz Basic Information  </h1>
      <ol class="breadcrumb">
         <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
         <li class="active">Edit Biz Basic Information</li>
      </ol>
   </section>
   ...
   <section class="content">
      <div class="box box-primary">
             ...
             <!-- form start -->
             <form id="edit-business-form" role="form" action="{{ route('admin.update_biz_basic_info',['slug' => $business->slug]) }}" enctype="multipart/form-data" method="POST">
              {{ csrf_field() }}
                <div class="box-body">
