                  ...
                  <tbody>
                    ...
                    <tr class="tr_{{ $loopingSubcategories->id }}">
                     ...
                     <td>
                      ...
                      <button id="active_{{ $loopingSubcategories->id }}" class="btn btn-success btn-flat active_subcategory @if($loopingSubcategories->status == '0') hide @endif" data-id="{{ $loopingSubcategories->id }}">Active</button>
