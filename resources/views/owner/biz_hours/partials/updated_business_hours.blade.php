             ...
             <form role="form" action="{{ route('owner.update_business_hours',['slug' => $business->slug]) }}" enctype="multipart/form-data" method="POST">
              {{ csrf_field() }}
                <div class="box-body">
                        ...
                        <div class="col-sm-9 col-xs-9 text-right @if($businessHours->thur_status == false) hide @endif">
                          <div class="hours"><label class="switch_margin"></label>
                            ...
                            <ul class="open-down">
                              ...
                              To
                              <div class="input-group bootstrap-timepicker timepicker">
                               <input type="text" class="form-control input-small timepicker1" name="thur_close" value="{{ $businessHours->thur_close }}">
                               <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                              </div>  
                            </ul>
                          </div>
