...
<section class="content">
  <div class="box box-primary">
   <!-- form start -->
   <form id="edit-speciality-form" role="form" action="{{ route('owner.update_speciality',['speciality_id' => $speciality->slug, 'slug' => $slug]) }}" enctype="multipart/form-data" method="POST">
    {{ csrf_field() }}
